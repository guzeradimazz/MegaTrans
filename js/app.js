...
//=================<div class="spollers-block__body" style="display: block;">
//Spollers
/*
...
// 	}, 0);
// }
//=================data-max="768" для название спойлера
//=================
...
//////////////////////////////Авто высота для картинки хедера - jQuery
// $(window).resize(function (event) {
//    header();
//  });
//  function header() {
//    var h = $(window).outerHeight();
//    $(".main-home").css("min-height", h);
//  }
//  header();

////////////////Авто высота для картинки хедера - JS
// window.addEventListener("resize", autoHeightBlock, true);
// function autoHeightBlock(){
//    let someBlock = document.querySelector(".height-test");
//    if (someBlock) {
//       someBlock.style.minHeight = screen.height - 10 + "px";
//    }
// }
...
// $(".calc-main__size").click(function(){
//       $('#input_vol').val('');
//       $('#input_vol').focus();
// });

$(".calc-main__size").on("click", function(){
    $('#input_vol').focus();
    $('#text').focus();
});
